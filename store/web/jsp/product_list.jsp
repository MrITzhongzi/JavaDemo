...
<c:if test="${not empty page.list}">
    ...
    <div class="row" style="width:1210px;margin:0 auto;">
        ...
        <div class="col-md-2">
            ...
            <p style="height: 40px;"><a href="${pageContext.request.contextPath}/jsp/product_info.jsp" style='color:green'>${pro.pname}</a></p>
            <p><font color="#FF0000">商城价：${pro.shop_price}</font></p>
        </div>
        </c:forEach>
